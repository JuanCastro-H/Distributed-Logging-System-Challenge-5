...
SERVICE       = "auth-service"               # Nombre del servicio. 
...
# --- Mensajes simulados ---
MESSAGES = [
    "User logged in successfully", # El usuario inicio sesion correctamente.
    "Invalid password attempt",    # Intento de contrasenha incorrecta.
    "Token expired",               # Token caducado.
    "User logged out",             # Usuario desconectado.
    "Database conection failed"    # Fallo la conexion con la base de datos.
]
